...
const Form = () => {
    ...
    return (
        <form onSubmit={sendEmail} className='max-w-[600px] w-[350px] mx-auto '>
            <div className='mb-6'>
                <input
                    className='bg-transparent text-black dark:text-white w-full py-2 px-3 border border-black dark:border-white rounded focus:outline-none focus:border-red'
                    type='text'
